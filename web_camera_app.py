...
# Flask-based web app for controlling the 360 camera on Raspberry Pi
...
<body>
    <div class="container">
        ...
        <div class="controls">
            ...
            <button id="btn-toggle-mode" class="btn-mode" disabled>表示モード: 左右並列</button>
        </div>
        
        <div class="status-box">
            <h3>ステータス:</h3>
            <p>- このウェブアプリからステレオカメラを制御できます</p>
            <p>- 録画したビデオは自動的にMP4に変換されます</p>
            <p>- '表示モード'ボタンで左右のカメラ表示を切り替えられます</p>
        </div>
    </div>
